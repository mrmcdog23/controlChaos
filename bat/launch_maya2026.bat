...
:: ============================================================
:: launch_maya2026.bat
:: Launches Autodesk Maya 2026 with the correct pipeline
...
set PYTHONPATH=C:\Program Files\Autodesk\Maya2026\Python\Lib\site-packages
...
set XBMLANGPATH=%PIPELINE_ROOT%\maya\icons\%B
